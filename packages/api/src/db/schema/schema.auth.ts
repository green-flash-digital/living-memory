...
export const household = pgTable(
  ...
  (table) => [uniqueIndex("household_slug_uidx").on(table.slug)]
);

export const user_household = pgTable(
  "user_household",
  {
    id: text("id").primaryKey(),
...
export const userRelations = relations(user, ({ many }) => ({
  ...
  user_households: many(user_household),
...
export const user_householdRelations = relations(user_household, ({ one }) => ({
  household: one(household, {
    fields: [user_household.householdId],
    references: [household.id]
  }),
  user: one(user, {
    fields: [user_household.userId],
    references: [user.id]
  })
}));
